...
use crate::ast::internal::{
    ...
    AssignmentPattern, AwaitExpression, BinaryExpression, BinaryOperator, BlockStatement,
    CallExpression, ConditionalExpression, Expression, Identifier, ImportExpression, JsdocCast,
    Literal, LiteralValue, MemberExpression, MetaProperty, NewExpression, ObjectPattern,
    ObjectPatternProperty, ObjectProperty, Property, RegexLiteral, RestElement, SequenceExpression,
