...
// and constructor types, type queries, import types) plus type parameters and
// type elements shared by type literals and interface bodies. Declarations
// that *introduce* types (alias, interface, enum, namespace, declare) live in
