 ...
 * Svelte depends on it by a caret range (`^2.2.12`). Before the lockfile the
 ...
 * that disambiguates a duplicate (`prettier-plugin-svelte@4.1.1_prettier@3.9.6_svelte@5.57.0`),
