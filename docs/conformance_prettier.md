...
- Between `}` and `else` → Into else block body — [else_leading_block_comment](../tests/fixtures/typescript/statements/if/else_leading_block_comment_prettier_divergence/)
