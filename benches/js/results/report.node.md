...
| tsv_wasm-json               | 3.44       | 18  | 290.16   | 291.39   | 291.97   | 292.05   | 292.08   | 288.67   | 292.09   | 2.12x                        |
| tsv-json-no-locations       | 6.08       | 30  | 164.42   | 165.18   | 165.44   | 165.61   | 167.94   | 163.00   | 168.89   | 3.75x                        |
| tsv_wasm-json-no-locations  | 5.44       | 26  | 183.64   | 184.37   | 184.64   | 185.00   | 185.38   | 182.33   | 185.46   | 3.35x                        |
| tsv-internal                | 45.55      | 211 | 21.95    | 22.00    | 22.09    | 22.33    | 22.65    | 21.81    | 22.80    | 28.1x                        |
| tsv_wasm-internal           | 32.42      | 145 | 30.84    | 30.90    | 31.10    | 31.31    | 31.55    | 30.73    | 31.67    | 20.0x                        |
...
**Throughput:** svelte/compiler 3.9 MB/s, tsv-json 8.9 MB/s, tsv_wasm-json 8.3 MB/s, tsv-json-no-locations 14.7 MB/s, tsv_wasm-json-no-locations 13.1 MB/s, tsv-internal 109.9 MB/s, tsv_wasm-internal 78.2 MB/s, rsvelte-parse 4.1 MB/s, rsvelte-parse-skip-expr-loc 6.3 MB/s
...
| tsv_wasm   | 9.13       | 46 | 0.11    | 0.11    | 0.11    | 0.11    | 0.11    | 0.11    | 0.11    | 51.8x                 |
| oxfmt      | 0.18       | 8  | 5.63    | 5.64    | 5.66    | —       | —       | 5.57    | 5.68    | 1.01x                 |
| biome-wasm | 0.86       | 8  | 1.16    | 1.17    | 1.17    | —       | —       | 1.15    | 1.18    | 4.88x                 |

**Files (intersection):** 951

**Throughput:** prettier 0.4 MB/s, tsv 30.6 MB/s, tsv_wasm 22.0 MB/s, oxfmt 0.4 MB/s, biome-wasm 2.1 MB/s
...
| tsv_wasm-json              | 0.45       | 8  | 2.20    | 2.21    | 2.21    | —       | —       | 2.20    | 2.22    | 1.59x                         |
| tsv-json-no-locations      | 0.97       | 8  | 1.03    | 1.03    | 1.03    | —       | —       | 1.03    | 1.03    | 3.41x                         |
| tsv_wasm-json-no-locations | 0.92       | 8  | 1.09    | 1.09    | 1.09    | —       | —       | 1.09    | 1.09    | 3.21x                         |
| tsv-internal               | 8.42       | 36 | 0.12    | 0.12    | 0.12    | 0.12    | 0.12    | 0.12    | 0.12    | 29.5x                         |
| tsv_wasm-internal          | 6.55       | 33 | 0.15    | 0.15    | 0.15    | 0.15    | 0.15    | 0.15    | 0.15    | 23.0x                         |
...
**Throughput:** acorn-typescript 5.3 MB/s, tsv-json 8.6 MB/s, tsv_wasm-json 8.4 MB/s, tsv-json-no-locations 18.0 MB/s, tsv_wasm-json-no-locations 16.9 MB/s, tsv-internal 155.3 MB/s, tsv_wasm-internal 120.8 MB/s, oxc-parser 13.2 MB/s, oxc-parser-wasm 12.8 MB/s, yuku-parser 43.1 MB/s, yuku-parser-wasm 49.8 MB/s, swc 10.0 MB/s
...
**JSON overhead** (json_ns / internal_ns, higher = more cost): tsv-json 18.1x tsv-internal, tsv_wasm-json 14.4x tsv_wasm-internal
...
| tsv_wasm    | 1.64       | 9  | 0.61    | 0.61    | 0.61    | —       | —       | 0.61    | 0.61    | 23.9x                 |
...
**Throughput:** prettier 1.3 MB/s, tsv 40.9 MB/s, tsv_wasm 30.3 MB/s, oxfmt 19.7 MB/s, biome-wasm 3.8 MB/s, dprint-wasm 5.6 MB/s
...
| tsv_wasm-json     | 41.41      | 169 | 24.14    | 24.37    | 26.09    | 26.45    | 32.53    | 23.88    | 32.60    | 0.47x                        |
| tsv-internal      | 215.26     | 956 | 4.65     | 4.65     | 4.67     | 4.70     | 4.80     | 4.63     | 4.92     | 2.44x                        |
| tsv_wasm-internal | 146.36     | 688 | 6.83     | 6.85     | 6.87     | 6.90     | 7.05     | 6.78     | 7.14     | 1.66x                        |
| postcss           | 81.90      | 317 | 12.17    | 12.52    | 12.91    | 13.22    | 13.75    | 12.07    | 14.19    | 0.93x                        |

**Files (intersection):** 55

**Throughput:** svelte/compiler 35.7 MB/s, tsv-json 18.0 MB/s, tsv_wasm-json 16.8 MB/s, tsv-internal 87.2 MB/s, tsv_wasm-internal 59.3 MB/s, postcss 33.2 MB/s

**JSON overhead** (json_ns / internal_ns, higher = more cost): tsv-json 4.8x tsv-internal, tsv_wasm-json 3.5x tsv_wasm-internal
...
| tsv_wasm   | 85.68      | 412 | 11.66    | 11.72    | 11.77    | 11.87    | 12.10    | 11.56    | 14.27    | 56.7x                 |
...
**Throughput:** prettier 0.6 MB/s, tsv 49.7 MB/s, tsv_wasm 34.7 MB/s, oxfmt 19.7 MB/s, biome-wasm 4.1 MB/s, malva-wasm 7.8 MB/s
