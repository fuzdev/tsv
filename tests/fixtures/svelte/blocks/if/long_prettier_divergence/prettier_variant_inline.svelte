<div>
	...
	{#if items
		.filter((x) => x.active)
		.map((x) => x.id)
		.includes(targetValueeeeeeeeeeeeeeeeeeeeeeeeee)}x{/if}
	...
	{#if foo(afffffffffffffffffffffffffffffffffffff, bbbbbbbbbbbbbbbbbbbbb, ssssssssssssssssssssss, d)
		.bar()
		.baz()
		.fooooooooooooooooooooooooooooooooooooooo()}x{/if}
	...
	{#if foo(afffffffffffffffffffffffffffffffffffff, bbbbbbbbbbbbbbbbbbbbb, ssssssssssssssssssssss, dd)
		.bar()
		.baz()
		.fooooooooooooooooooooooooooooooooooooooo(aaaaaaaaaaaaaaaaaaaa, bbbbbbbbbbbbb, ccccccccccccccccc)}x{/if}
	...
	{#if a
		.filter((item) => item.x)
		.filter((item) => item.yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy)}x{/if}
</div>
