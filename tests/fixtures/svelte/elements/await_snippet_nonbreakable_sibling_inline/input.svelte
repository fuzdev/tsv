...
<!-- comment sibling + await -->
<div><!-- c -->{#await promise}loading{/await}</div>

<!-- text sibling + snippet -->
<div>text {#snippet fn()}content{/snippet}</div>

<!-- comment sibling + snippet -->
<div><!-- c -->{#snippet fn()}content{/snippet}</div>
