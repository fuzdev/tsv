...
<div>
	<span>inline1</span> <!-- ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc -->
</div>
<div>
	<span>inline1</span> {#if cond}cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc{/if}
</div>
<div>
	<span>inline1</span> {#if cond}ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc{/if}
</div>
