...
<!-- 101 chars, text between the tags - the content flows as one fill, so they share a line -->
<div>
	<small>{a} and {cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc}</small>
</div>
