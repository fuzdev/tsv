...
<!-- in an inline element: an icon and its caption -->
<button>
	<Icon />
	text1
</button>

<!-- in a list item and a table cell -->
<ul>
	<li>
		<Icon />
		text1
...
<!-- inside a control-flow block, and inside a snippet body -->
{#if cond}
	<Icon />
	text1
{/if}
...
<!-- control: a two-word run in the same inline container is prose, and flows -->
<button>
	<Icon />
	text1 text2
</button>
