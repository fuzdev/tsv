<!--
	...
	wraps); the same at 101 (the unit travels and the follower packs after it). Prettier
	keeps each glued run on the text line and dangles the tag delimiters — see
