...
Stable quirk. tsv normalizes comment spacing consistently across all CSS contexts. See [conformance_prettier_css.md §CSS: Comments](../../../../../../docs/conformance_prettier_css.md#css-comments).
