...
Svelte's CSS parser requires spaces around `||` — without them it fails with "Expected a valid CSS identifier". tsv prioritizes Svelte compatibility. CSS Selectors Level 4 marks the column combinator as "At Risk".
