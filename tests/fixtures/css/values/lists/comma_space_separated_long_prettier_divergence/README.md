...
Print width. tsv treats printWidth as a hard limit. At 100 and 102 chars both formatters match — this divergence only manifests at the 101-char boundary. See [conformance_prettier_css.md §CSS: Values](../../../../../../docs/conformance_prettier_css.md#css-values) ("Comma+space value boundary").
