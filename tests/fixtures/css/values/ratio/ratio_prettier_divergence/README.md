...
Stable quirk. tsv normalizes whitespace consistently regardless of context (property value vs media query); prettier preserves the extra spaces inside a media-query ratio. See [conformance_prettier_css.md §CSS: Values](../../../../../../docs/conformance_prettier_css.md#css-values) ("Ratio in media queries").
