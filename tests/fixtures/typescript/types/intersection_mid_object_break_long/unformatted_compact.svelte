<script lang="ts">
	...
	type Break101=AAAAAAAAAAAAAAAAAAAA&{a:number;b:string;c:boolean}&CCCCCCCCCCCCCCCCCCCC;
	...
	type Cons=AAAAAAAAAA&{a:A}&{bbbbbbbbbb:B;cccccccccc:C;dddddddddd:D;eeeeeeeeee:E}&FFFF;
</script>
