<script lang="ts">
	...
	type Wrapped = {
		[  K   in   keyof   SomeTypeAAAAAAAAAAAAAAAAAAAAAAA  ]  :   SomeTypeAAAAAAAAAAAAAAAAAAAAAAAA  [  K  ]  ;
	};
	...
	type ReadonlyWrapped = {
		readonly   [  K   in   keyof   SomeTypeAAAAAAAAAAAAAAA  ]  :   SomeTypeAAAAAAAAAAAAAAA  [  K  ]  ;
	};
	...
	type OptionalWrapped = {
		[  K   in   keyof   SomeTypeAAAAAAAAAAAAAAAAAAA  ]  ?  :   SomeTypeAAAAAAAAAAAAAAAAAAA  [  K  ]  ;
	};
	...
	type RequiredWrapped = {
		[  K   in   keyof   SomeTypeAAAAAAAAAAAAAAAAAA  ]  -  ?  :   SomeTypeAAAAAAAAAAAAAAAAAAA  [  K  ]  ;
	};
