<script lang="ts">
	...
	type Wrapped={[K in keyof SomeTypeAAAAAAAAAAAAAAAAAAAAAAA]:SomeTypeAAAAAAAAAAAAAAAAAAAAAA[K]};
	...
	type ReadonlyWrapped={readonly [K in keyof SomeTypeAAAAAAAAAAAAA]:SomeTypeAAAAAAAAAAAAAAA[K]};
	...
	type OptionalWrapped={[K in keyof SomeTypeAAAAAAAAAAAAAAAAAAA]?:SomeTypeAAAAAAAAAAAAAAAAA[K]};
	...
	type RequiredWrapped={[K in keyof SomeTypeAAAAAAAAAAAAAAAAAA]-?:SomeTypeAAAAAAAAAAAAAAAAA[K]};
