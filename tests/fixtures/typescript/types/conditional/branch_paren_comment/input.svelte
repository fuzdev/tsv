<script lang="ts">
	...
	type G = Taaaaaaaaaaaaaaaaaaaaaa extends Uaaaaaaaaaaaaaaaaaaaaaa
		? /* c */ Vaaaaaaaaaaaaaaaaaaaaaa extends Waaaaaaaaaaaaaaaaaaaaaa
			? Xaaaa
			: Yaaaa
		: Zaaaa;
	type H = Taaaaaaaaaaaaaaaaaaaaaa extends Uaaaaaaaaaaaaaaaaaaaaaa
		? Vaaaaaaaaaaaaaaaaaaaaaa extends Waaaaaaaaaaaaaaaaaaaaaa
			? Xaaaa
			: Yaaaa /* c */
		: Zaaaa;
