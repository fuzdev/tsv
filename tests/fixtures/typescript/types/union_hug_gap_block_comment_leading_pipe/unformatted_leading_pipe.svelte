<script lang="ts">
	...
	interface Multiple {
		a: /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccc } | null;
	}
	type C = /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc } | null;
	type D = () => /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc } | null;
	function ret(): /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc } | null {}
	function param(
		a: /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccccccc } | null,
		b: string
	) {}

	// A container and a keyword
	type E = Map<string, /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc } | null>;
	type F = T extends U ? /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccc } | null : 2;

	// An expanded member; two blocks around the pipe; a block and then a line comment
	let g: /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc; dddd: D; eeee: E } | null;
	let h: /* c1 */ | /* c2 */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Ccccccccccccccccccccccccc } | null;
	let i: /* c */ | // d
	...
	let j: /* c */ | { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccccccccccccc };
