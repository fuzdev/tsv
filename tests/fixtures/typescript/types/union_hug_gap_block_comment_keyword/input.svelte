<script lang="ts">
	...
	function b<
		T extends /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; ccc: Cccccccccccccccccc } | null
	>() {}
	function c<
		T extends
			/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; ccc: Ccccccccccccccccccccccccccccccccc } | null
	>() {}
	function d<
		T extends
			/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; ccc: Cccccccccccccccccccccccccccccccccccccccc } | null
	>() {}
	function e<
		T extends
			| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; ccc: Ccccccccccccccccccccccccccccccccccccccccc }
			| null
	>() {}
	function f<
		T =
	...
	type G = T extends
		| /* c */ {
				aaaa: Aaaaaaaaa;
				bbb: Bbbbbb;
				cccccccccccccccccccc: Cccccccccccccccccccccccc;
				dddd: D;
		  }
		| null
		? 1
		: 2;
	type H = T extends U
		? /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Ccccccccccccccccccccccc } | null
		: 2;
	type I = T extends U
		? 1
		: | /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Ccccccccccccccccccccccc }
			| null;
	type J = T extends U
		? | /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccc }
			| null
	...
	type L = {
		[
			K in
				| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccc }
				| null
		]: 1;
	};
	type M = {
