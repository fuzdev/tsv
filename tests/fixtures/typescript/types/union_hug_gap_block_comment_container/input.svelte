<script lang="ts">
	...
	let b: Foo<
		/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Ccccccccccccccc } | null
	>;
	let c: Foo<
		| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccccc }
		| null
	>;
	fn<
		| /* c */ {
	...
	let f: (
		/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccc } | null
	)[];
	let g: (
		| /* c */ {
				aaaa: Aaaaaaaaa;
	...
	let h: keyof (
		/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccc } | null
	);
	let i: keyof (
		| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Ccccccccccccccccccccccccccccc }
		| null
	);
