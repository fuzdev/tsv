# Parser divergence: comment duplication in a function type's parameter list

A comment inside a function type's empty parameter parentheses falls in a region acorn-typescript re-parses — its backtrack-and-reparse
