<script lang="ts">
	...
	class  Single  {
		a  :  /* c */  {  aaaa  :  Aaaaaaaaa  ;  bbb  :  Bbbbbb  ;  cccccccccccccccccccc  :  Cccccccccccccccccccccccccc  }  |  null  ;
	}
	interface  Multiple  {
		a  :  /* c */  {  aaaa  :  Aaaaaaaaa  ;  bbb  :  Bbbbbb  ;  cccccccccccccccccccc  :  Cccccccccccccccccccccccccccc  }  |  null  ;
		[  key  :  string  ]  :  /* c */  {  aaaa  :  Aaaaaaaaa  ;  bbb  :  Bbbbbb  ;  cccccccccc  :  Cccccccccccccccccccccccccc  }  |  null  ;
	}
