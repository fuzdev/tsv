<script lang="ts">
	...
	let a:
		/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccc } | null;
	let b:
		| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Ccccccccccccccccccccccccc }
		| null;
	let c:
		| /* c */ Map<
				string,
				numberrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
		  >
		| null;
	let d:
		| /* c */ null
		| { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc };

	// Class property and interface members
	class Single {
		a:
			| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc }
			| null;
	}
	interface Multiple {
		a:
			| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccccc }
			| null;
		[key: string]:
			/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccc: Cccccccccccccccccccccccccc } | null;
	}

	// Parameter, return type, and the function-type `=>`
	function param(
		a: /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccc } | null,
		b: string
	) {}
	function ret():
		| /* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccccccccc }
	...
	type D = {
		[K in T]:
			/* c */ { aaaa: Aaaaaaaaa; bbb: Bbbbbb; cccccccccccccccccccc: Cccccccccccccccccccc } | null;
	};
