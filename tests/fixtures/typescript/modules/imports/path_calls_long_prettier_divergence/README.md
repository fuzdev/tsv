...
Print width. tsv wraps consistently — lines should respect printWidth, and function calls should wrap the same way regardless of the callee.

See [conformance_prettier_ts.md §TypeScript](../../../../../../docs/conformance_prettier_ts.md#typescript) (Module path calls) and [§Print Width Philosophy](../../../../../../docs/conformance_prettier.md#print-width-philosophy).
