...
Block comment trailing the last export specifier's comma (`bbb..., /* c */`).
...
Only the **last** specifier diverges, and only in multiline form — the long
names here force the export to expand, keeping the trailing comma.
