...
a comment in either header gap — `export`→`type` or `type`→`{` — becomes the
...
The import sibling is
[modules/imports/type_keyword_comment_long](../../imports/type_keyword_comment_long_prettier_divergence/).
