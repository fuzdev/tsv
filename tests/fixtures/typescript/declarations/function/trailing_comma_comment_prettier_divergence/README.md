...
Block comment trailing the last function parameter's comma (`bbb..., /* c */`).
...
Only the **last** parameter diverges, and only in multiline form — the long
names here force the parameter list to expand, keeping the trailing comma.
