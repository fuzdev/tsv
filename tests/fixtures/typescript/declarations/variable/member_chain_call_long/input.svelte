<script>
	...
	const { a1, b1, c1aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa } = a.fn(() => ({
		a1: x()
	}));
	...
	const { a3, b3, c3aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa } =
		a.fn(() => ({
			a3: x(),
			b3: y()
		}));
