...
acorn-typescript's backtrack-and-reparse duplicates a before-key comment of a
class computed member in the root `comments` array; tsv keeps a single entry
