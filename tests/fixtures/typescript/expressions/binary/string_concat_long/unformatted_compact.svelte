<script>
	...
	const a='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'+'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb';
	...
	const d=`aaa ${expr} aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa`+`bbb ${expr} bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb`;
</script>
