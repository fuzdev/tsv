<script lang="ts">
	// Object declaration with blank line between properties
	const {a,
...
...rest} = obj;
	...
	// Nested with blank lines preserved at each level
	const {outer: {inner,
...
typed2}: {typed1: string; typed2: number} = obj;

	// With satisfies
	const {sat1,

sat2} = obj satisfies SomeType;
