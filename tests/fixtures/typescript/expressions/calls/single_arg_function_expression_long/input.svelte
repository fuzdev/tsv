<script lang="ts">
	...
	fnAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA(
		function () {}
	);
	...
	fnAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA(
		function named(paramOne, paramTwo, paramThree, paramFour, paramFive) {
			s();
		}
	);

	// A default value leaves the list breakable, so the same width hugs and breaks the parameters.
	fnAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA(function named(
		paramOne,
		paramTwo = 1,
		paramThree,
		paramFour,
	...
	new AAAAAAAAAAAAAAAAAAAAAAAAAAAA(function named(
		paramOne,
		paramTwo,
		paramThree,
		paramFour,
