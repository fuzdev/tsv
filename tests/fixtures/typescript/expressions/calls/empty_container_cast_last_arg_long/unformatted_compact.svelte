<script lang="ts">
	...
	aaaa.bbbb((acc,curr)=>acc.concat(curr.ccccccccccccccccccc),<Dddddddddddddddddddddddddddd[]>[]);
	aaaa.bbbb((acc,curr)=>acc.concat(curr.cccccccccccccccccccc),[] as Ddddddddddddddddddddddddd[]);
	aaaa.bbbb((acc,curr)=>acc.concat(curr.cccccccccccccccccc),<Ddddddddddddddddddddddddddddddd>{});

	// the chain spelling of the same call
	aaaa(bbbb,ccccccccccccccc)?.reduce((acc,curr)=>acc.concat(curr.eeee),<Ddddddddddddddddd[]>[]);
	...
	aaaa.bbbb((acc,curr)=>acc.concat(curr.cccccccccccccccccc),<Ddddddddddddddddddddd[]>/* c */ []);
	aaaa.bbbb((acc,curr)=>acc.concat(curr.ccccccccccccccccc),<Dddddddddddddddddddddddd>/* c */ {});

	// a NON-EMPTY literal under the cast still hugs, and so does an empty one holding a comment
	aaaa.bbbb((acc,curr)=>acc.concat(curr.ccccccccccccccccccc),<Ddddddddddddddddddddddddddd[]>[1]);
	aaaa.bbbb((acc,curr)=>acc.concat(curr.cccccccccccccccccccc),<Dddddddddddddddddddd[]>[/* c */]);
</script>
