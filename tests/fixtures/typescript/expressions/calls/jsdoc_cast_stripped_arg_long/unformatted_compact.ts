...
a(b_______,/** @type {Expression} */ (fn(c,d,e__________________________________________________)));

// Expanded with comment inline: comment stays on same line as expression
a(b________________________________________,/** @type {Expression} */ (fn(c,d,e__________________________________________________)));
