<script>
	// Outer boundary tests: this.fn().call(inner(...))
	// Tests whether chain stays together or breaks after `this`

	// 100 chars - stays inline (64 a's)
	const a = this.fn().call(inner(aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa));

	// 101 chars - breaks after .call( (65 a's)
	const b = this.fn().call(inner(aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa));
