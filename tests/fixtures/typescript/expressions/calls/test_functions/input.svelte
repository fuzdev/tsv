<script lang="ts">
	// Core test functions - stay on one line even if long
	...
	describe('does something really long and complicated so I have to write a very long name for the test', () => {});

	// With skip/only variants
	...
	// Focus/skip prefixes
	xit('does something really long and complicated so I have to write a very long name for the test', () => {});
	fit('does something really long and complicated so I have to write a very long name for the test', () => {});

	// With timeout (third argument)
	it('does something really long and complicated so I have to write a very long name', () => {}, 5000);
</script>
