# Parser divergence: comment duplication in an arrow's return-type annotation

A comment between a typed-parameter arrow function's return type and its `=>` falls in a region acorn-typescript re-parses — its backtrack-and-reparse
