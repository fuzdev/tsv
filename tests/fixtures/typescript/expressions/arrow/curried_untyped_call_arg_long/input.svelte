<script>
	...
	fn(
		(argument1) => (argument2) => (argument3) => (argument4) => (argument5) => (argument6xxxxxxx) =>
			body
	);
	...
	fn(
		'first',
		(argument1111111, argument2222222, argument3333333, argument4444444, argument5555) =>
			(argument6) =>
				body
	);
	...
	fn(
		(argument1111111, argument2222222, argument3333333, argument4444444, argument5555555) =>
			(argument6) => {
				return body;
			}
	);
	...
	fn(
		aaa,
		(argument1111111, argument2222222, argument3333333, argument4444444, argument55) =>
			(argument6) =>
				body /* c */
	);
	...
	fn((a = 1) => (b) => {
		return g(
			(argument1111111, argument2222222, argument3333333, argument4444444, argument5) =>
				(argument6) =>
					body
		);
	});
