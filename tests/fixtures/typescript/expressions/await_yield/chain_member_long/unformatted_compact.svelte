<script lang="ts">
	async function fn() {
		...
		const b = (await fn({...o, a: bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb})).prop?.method();

		// Inner await line at 100 chars - object stays compact
		const c = (await fn({...o, a: bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb})).prop?.method();

		// Inner await line at 101 chars - object expands
		const d = (await fn({...o,a: bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb})).prop?.method();

		// Property value at 100 chars - stays on single line within expanded object
		const e = (await fn({...o,a: bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb})).prop?.method();

		// Property value at 101 chars - still single line (object already expanded, no further break)
		const f = (await fn({...o,a: bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb})).prop?.method();
	}
</script>
