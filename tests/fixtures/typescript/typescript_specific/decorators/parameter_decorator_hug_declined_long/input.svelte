<script lang="ts">
	...
	class Boundary {
		...
		fn101(
			@dec a: { aaa: Aaaa; bbb: Bbbb; ccc: Cccc; ddd: Dddd; eee: Eeee; ffffff: Ffffff }
		): void {}
		...
		pattern(
			@dec { aaa, bbb, ccc, ddd, eee, fff, ggg, hhh, iii, jjj, kkk, lll, mmm, nnn }: T
		): void {}
		arrayPattern(
			@dec [aaa, bbb, ccc, ddd, eee, fff, ggg, hhh, iii, jjj, kkk, lll, mmmm]: T
		): void {}

		// Any decorator in the list declines it
		multi(
			@dec1 @dec2 a: { aaa: Aaaa; bbb: Bbbb; ccc: Cccc; ddd: Dddd; eee: Eeee; ff: Ffff }
		): void {}
	}
</script>
