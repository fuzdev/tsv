# Parser divergence: comment duplication in an empty call type-argument list

A comment inside an empty call type-argument list `<>` falls in a region acorn-typescript re-parses — its backtrack-and-reparse
